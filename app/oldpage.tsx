      ...
      <div className="px-6 pt-6 pb-5 min-h-[108px]">
        <p className="text-[16px] text-foreground leading-relaxed">
          ...
          {typedChars < SAMPLE_STATEMENT.length && (
            <span className="inline-block w-[2px] h-[18px] bg-gradient-to-br from-red-500 to-amber-500 ml-0.5 align-middle animate-pulse" />
          )}
        </p>
      </div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className={`max-w-4xl mb-14 transition-all duration-700 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-3 flex-wrap">
              <Link
                href="/register"
                className="px-7 py-3.5 rounded-xl bg-gradient-to-br from-red-500 to-amber-500 hover:bg-blue-700 active:bg-blue-800 text-white font-semibold text-[15px] transition-colors flex items-center justify-center gap-2 shadow-lg shadow-blue-600/20"
              >
                Check My Score
      ...
      <section id="method" className="py-20 sm:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 rounded-2xl border border-blue-200 dark:border-blue-800 bg-blue-50/60 dark:bg-blue-950/30 p-7 sm:p-8 flex items-center justify-between gap-6 flex-wrap">
            ...
            <Link
              href="/register"
              className="shrink-0 px-6 py-3 rounded-xl bg-gradient-to-br from-red-500 to-amber-500 hover:bg-blue-700 text-white font-semibold text-[14px] transition-colors flex items-center gap-2"
            >
              Predict My Interview Chances
              <ArrowRight className="h-4 w-4" />
            </Link>
              ...
              >
                ...
                <Link
                  ...
                  className={`block w-full py-2.5 rounded-xl font-semibold text-[14px] text-center mb-8 transition-all ${
                    tier.featured
                      ? 'bg-gradient-to-br from-red-500 to-amber-500 hover:bg-blue-700 text-white shadow shadow-blue-600/30'
          ...
          <div className="grid md:grid-cols-4 gap-10 mb-12">
            <div>
              <div className="flex items-center gap-2.5 mb-4">
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-red-500 to-amber-500 text-white flex items-center justify-center font-semibold text-[11px] tracking-wide">
                  NHS
                </div>
