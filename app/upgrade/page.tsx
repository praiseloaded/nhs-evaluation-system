...
const proPlan = {
  ...
  name: 'Pro',
  price: '£14.99',
  desc: 'Everything you need to get shortlisted — rewrites, rejection analysis, and unlimited scans.',
  included: [
    'Everything in Free',
    'Unlimited statement scans',
    'Full statement rewrite',
    'Language mirroring',
    'Rejection risk analysis',
    'Operational realism scoring',
    'Band-specific coaching',
    'AI interview prep (VBI)',
    'Application tracker',
