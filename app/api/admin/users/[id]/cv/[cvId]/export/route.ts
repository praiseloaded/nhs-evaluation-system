...
export const GET = withAdminAuth(async (req: Request, admin: any, ctx: any) => {
  ...
  const doc = new Document({
    ...
    numbering: {
      config: [{ reference: "cv-bullets", levels: [{ level: 0, format: LevelFormat.BULLET, text: "•", alignment: AlignmentType.LEFT, style: { paragraph: { indent: { left: 420, hanging: 240 } } } }] }],
    },
    sections: [{
